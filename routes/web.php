...
Route::get('/products/print-all', [ProductController::class, 'printAll'])
    ->middleware('auth')
    ->name('products.printAll');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/products/print-all', [ProductController::class, 'printAll'])->name('products.printAll');
    Route::resource('products', ProductController::class);
